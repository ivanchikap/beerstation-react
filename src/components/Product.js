        ...
        <div className="main__col">
            <div onClick={onProductClick} data-name={prod.name} className="card" id={prod.name}>
                <div className="card__img">
                    ...
                    {!prod.isInShop && <Badge text={prod.isInShopText} type='road'/>}
                    {prod.discount && <Badge text={prod.discountText} type='warning' />}
                </div>
                        ...
                        <div className="card__price-wrapper">
                            <div className="card__price">
                                <div className="card__price-value">
                                    <span className={prod.discountType === "lowerPrice" ? "line-through" : ""}>{prod.price}</span>
                                    {prod.discountType === "lowerPrice" && (<p>{prod.discountedPrice}</p>)}
                                </div>
