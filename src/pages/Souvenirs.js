    ...
    return (
        <section className="section js-tab-content beer">
            <div className="container">
                <h2 className="section__title section__title--kran">Сувеніри</h2>
                <div className="main">
...
export const souvenirsLoader = async ({request, params}) => {
    console.log(request.url.split('/'));
    const res = await fetch(`http://localhost:4000/souvenirs`)
